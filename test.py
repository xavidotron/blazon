...
class TestCases(unittest.TestCase):
    ...
    def test_one(self):
        self.assertEquals(
            ['ARM:1:argent:primary:embowed', 'ARM:1:primary', 'HORN AND ATTIRES:1:or'], 
        ...
        self.assertEquals(
            ['OR', 'FIELD TREATMENT-SEME (CRUSILLY):sable', 'CRAC:sable', 'CROSS:1:gules:primary', 'CROSS:1:primary', 'BIRD:1:or:eagle:displayed', 'BIRD9DEMI:1:or:eagle:displayed'], 
        ...
        self.assertEquals(
            ['PB:purpure:~and sable', 'HEADDOG:1:argent:primary', 'HEADDOG:1:primary', 'FLOWER-IRIS AND ORCHID:1:argent:primary:bendwise', 'FLOWER-IRIS AND ORCHID:1:primary'], 
        ...
        self.assertEquals(
            ['AZ', 'BEAST-BEAR:1:or:primary:rampant', 'BEAST-BEAR:1:primary', 'KNOT AND ROPE:3:or'], 
            list(parse(u'Azure, a bear rampant and in chief three quatrefoil knots Or.').describe()))
        self.assertEquals(
            ['AZ', 'DOG:1:argent:primary:sejant', 'DOG:1:primary', 'CHIEF:1:argent', 'LETTERS,RUNES AND SYMBOLS:azure'], 
        ...
        self.assertEquals(
            ['BIRD:1:multicolor:primary:volant to dexter', 'BIRD9DEMI:1:multicolor:primary:volant to dexter', 'BIRD:1:primary'],
            list(parse(u'(Fieldless) A swallow volant per fess azure and argent\n\n').describe()))
        self.assertEquals(
            ['AR', 'FESS:2:azure:primary:wavy', 'FESS:2:primary', 'ROUNDEL:1:sable', 'CRESCENT:2:sable'],
        ...
        self.assertEquals(
            ['ESTOILE:1:argent:primary:of 5', 'STAR:1:argent:primary:of 5', 'ESCARB:1:argent:primary:of 5', 'ESTOILE:1:primary'],
        ...
        self.assertEquals(
            [u'QLY:sable:~and multicolor', 'FIELD TREATMENT-VAIRY', 'CASTLE:3:or:primary:palewise', 'CASTLE:3:primary', 'ARRANGEMENT-IN BEND:or'],
        ...
        self.assertEquals(
            ['GU',
             ...
             'HEAD-BEAST,RAM AND GOAT:2:primary',
